    ...
    <div class="container">
        <div class="card">
            <div class="xformdm">
                ...
                <div class="form mt-4">
                    <form enctype="multipart/form-data" action="{{ route('supplier.surat.update', $surat->id) }}"
                        method="POST">
                        @csrf
    ...
    <div class="container">
        <div class="card">
            <div class="xformdm">
                ...
                <br>
                <form enctype="multipart/form-data" action="{{ route('supplier.surat.update', $surat->id) }}" method="POST">
