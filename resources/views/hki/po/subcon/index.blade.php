...
<div class="container">
    ...
    <div class="mb-2" style="text-align: left">
        <a href="{{route('hki.po.subcon.create')}}" class="btn btn-primary shadow"><i
                class="fa-solid fa-square-plus"></i> Tambah PO</a>
        <a href="#" class="btn btn-info shadow" style="color: white" data-bs-toggle="modal"
            data-bs-target="#exampleModal"><i class="fa-sharp fa-solid fa-cloud-arrow-up"></i> Upload PO</a>
    </div>
                ...
                <table id="myTable2" class="display nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$data->nama}}</td>
                            <td>
                                <select name="status" class="form-select" id="status{{$data->id_po}}"
                                    onchange="ubahStatus({{$data->id}})">
                                    <option value="" @if($data->status == "") selected @endif>--Status --</option>
                                    <option value="Unsend" @if($data->status == "Unsend") selected @endif>Unsend
                                    </option>
                                    <option value="On Progress" @if($data->status == "On Progress") selected @endif>On
                                        Progress</option>
                                    <option value="Finish" @if($data->status == "Finish") selected @endif>Finish
                                    </option>
                                </select>
                            </td>
                            <td style="width:40%">
                        ...
                        <div style="text-align: left" class="row">
                            <div class="col col-md-12 col-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('po_number') is-invalid @enderror"
                                        id="po_number" name="po_number" placeholder="Masukkan po_number"
                                        value="{{$item->po_number}}" readonly>
                                    @error('po_number')
                            ...
                            <div class="col col-md-12 col-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('delivery_time') is-invalid @enderror"
                                        ...
                                        value="{{$item->delivery_time}}" readonly>
                                    @error('delivery_time')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
